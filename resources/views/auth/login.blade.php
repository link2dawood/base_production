            ...
            <div class="card-body px-4">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-outline mb-4">
                        <input type="email" id="Username" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" />
                        @error('email')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                        ...
                        <input type="Password" id="Password" class="form-control @error('password') is-invalid @enderror" ><br>
                        @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror
                        <div>
                            <button type="button" class="btn btn-danger btn-block">{{ __('Login') }}</button>
                            ...
                            <div class="text-lg-start mt-3 font-weight-light">
                                <p class="small fw-bold mt-2 pt-1 mb-0">New to Mash. ?<a href="{{url('/register')}}"
